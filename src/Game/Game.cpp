...
bool CGame::init()
{
    auto pDefaultShaderProgram = CResourceManager::loadShaders("DefaultShader", "res/shaders/vertex.txt", "res/shaders/fragment.txt");
    ...
    auto pTexture = CResourceManager::loadTexture("DefaultTexture", "res/textures/map_16x16.png");
